...
const Component2 = () => {
  return (
    ...
    <div>
        <div class="max-w-screen-lg max-md:max-w-xl mx-auto font-[sans-serif] my-4">
      ...
      <div class="mt-16">
        <div class="grid md:grid-cols-2 items-center gap-16">
          ...
          <div>
            ...
            <p class="text-gray-600 text-2xl">Transform your event space with stunning decorations that align with your theme and style. Whether it&apos;s an intimate gathering or a grand celebration, our expert decorators will create the perfect ambiance for your party.</p>
            <ul>
              <li className='py-1 text-2xl font-normal'>
                <span className='font-bold text-2xl'>Basic Decoration : </span> Simple yet elegant décor with balloons, banners, and minimal table settings 
              </li>
              <li className='py-1 text-2xl font-normal'>
                <span className='font-bold text-2xl'>Premium Decoration : </span> Themed decorations with floral arrangements, stage setup, and lighting enhancements.
              </li>
              <li className='py-1 text-2xl font-normal'>
                <span className='font-bold text-2xl'>Elite Decoration : </span> Luxurious décor including custom centerpieces, intricate stage designs, mood lighting, and more.
              </li>
            </ul>
            <a href='/contact-form'
          ...
          <div>
            ...
            <p class="text-gray-600 text-2xl">Delight your guests with a delicious spread of food and beverages tailored to your event. Our catering team is skilled in preparing a variety of cuisines, ensuring high quality and taste in every bite.</p>
            <ul>
              <li className='py-1 text-2xl font-normal'>
                <span className='font-bold text-2xl'>Basic Catering : </span> A well-curated selection of starters, main courses, and desserts
              </li>
              <li className='py-1 text-2xl font-normal'>
                <span className='font-bold text-2xl'>Premium Catering : </span> Expanded menu options with live counters, specialized dishes, and mocktails
              </li>
              <li className='py-1 text-2xl font-normal'>
                <span className='font-bold text-2xl'>Elite Catering : </span>Gourmet cuisine, exclusive live stations, personalized menus, and signature drinks.
              </li>
            </ul>
            <a href='/contact-form'
              class="px-6 py-2 mt-8 rounded-lg text-white text-2xl tracking-wider font-medium outline-none border-2 border-pink-600 bg-pink-600 hover:bg-transparent hover:text-black transition-all duration-300">
          ...
          <div>
            ...
            <p class="text-gray-600 text-2xl">Capture every special moment with our professional photography services. Whether it&apos;s candid shots or formal group pictures, our photographers will ensure that you have timeless memories of your event.</p>
            <ul>
              <li className='py-1 text-2xl font-normal'>
                <span className='font-bold text-2xl'>Basic Photography : </span>Professional event coverage with candid and posed shots.
              </li>
              <li className='py-1 text-2xl font-normal'>
                <span className='font-bold text-2xl'>Premium Photography : </span>Full event coverage with pre-event shoots, candid and cinematic photography.
              </li>
              <li className='py-1 text-2xl font-normal'>
                <span className='font-bold text-2xl'>Elite Photography : </span> Comprehensive photo and video coverage, including drone shots, albums, and highlight reels.
              </li>
            </ul>
            <a href='/contact-form'
              class="px-6 py-2 mt-8 rounded-lg text-white text-2xl tracking-wider font-medium outline-none border-2 border-pink-600 bg-pink-600 hover:bg-transparent hover:text-black transition-all duration-300">
