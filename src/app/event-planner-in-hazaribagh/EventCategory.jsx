    ...
    const treatmentData = [
        {
            ...
            image: img7,
            text: "Wedding Events",
            link: "wedding-planner-in-Hazaribagh",
            price: 4999,
            imgarr: [img1, img2, img3],
            desc: "Best Wedding Events Planners in Hazaribagh"
        },
        {
            key: 3,
            image: img8,
            text: "Engagment",
            link: "engagement-planner-in-Hazaribagh",
            price: 4999,
            imgarr: [img1, img2, img3],
            desc: "Engagement Events Planners in Hazaribagh"
        },
        {
            key: 1,
            image: img1,
            text: "Birthday",
            link: "birthday-event-planner-in-Hazaribagh",
            price: 4999,
            imgarr: [img1, img2, img3],
            desc: "Best Birthday Events Planners in Hazaribagh"
        },
        {
            key: 2,
            image: img2,
            text: "Anniversary",
            link: "anniversary-event-planner-in-Hazaribagh",
            price: 7999,
            imgarr: [img1, img2, img3],
            desc: "Best Anniversary Planners in Hazaribagh"
        },
        {
            key: 3,
            image: img3,
            text: "Corporate Events",
            link: "corporate-event-planner-in-Hazaribagh",
            price: 9999,
            imgarr: [img1, img2, img3],
            desc: "Best Corporate Events Planners in Hazaribagh"
        },
        {
            key: 3,
            image: img4,
            text: "House Warming Cermony",
            link: "house-warming-event-planner-in-Hazaribagh",
            price: 6999,
            imgarr: [img1, img2, img3],
            desc: "Best House warming Planners in Hazaribagh"
        },
        {
            key: 3,
            image: img5,
            text: "Baby Shower",
            link: "baby-shower-event-planner-in-Hazaribagh",
            price: 5999,
            imgarr: [img1, img2, img3],
            desc: "Best Baby shower Planners in Hazaribagh"
        },
        {
            key: 3,
            image: img6,
            text: "Rituals Events",
            link: "ritual-event-planner-in-Hazaribagh",
            price: 4999,
            imgarr: [img1, img2, img3],
            desc: "Best Ritual Events Planners in Hazaribagh"
        },
